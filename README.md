...
- **Pomodoro Timer** - Core timer functionality
- **App/Site Blocking** - Blocks apps and websites while Pomodoro Timer is active
- **Break Enforcement** - Enforces Pomodoro breaks automatically
- **Simple Landing Page** - Landing page to download the app

### Future Phases

- **Time Tracking** - Proper time tracking and analytics
- **Zone-Based Blocking** - Blocking via focus zones (work, break, deep work, etc.)
- **Daily Planning** - Plan your day and automatic enforcement based on schedule
